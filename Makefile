...
TEXT_CXXFLAGS = -I. `$(WX_CONFIG) --cxxflags $(WX_CONFIG_FLAGS)` $(CPPFLAGS) \
	$(CXXFLAGS)
TEXT_OBJECTS =  \
	text_text.o
...
all: test_for_selected_wxbuild text
...
text: $(TEXT_OBJECTS)
	$(CXX) -o $@ $(TEXT_OBJECTS)   $(LDFLAGS)  `$(WX_CONFIG) $(WX_CONFIG_FLAGS) --libs core,base`

text_text.o: ./main.cpp
